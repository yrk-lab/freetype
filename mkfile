...
HFILES=\
	include/p9ftopt.h \
	include/freetype/config/p9lib.h \

CFLAGS=-p -Iinclude \
	-D'FT_CONFIG_OPTIONS_H=<p9ftopt.h>' \
	-D'FT_CONFIG_STANDARD_LIBRARY_H=<freetype/config/p9lib.h>' \
	-DFT2_BUILD_LIBRARY \
...
include/p9ftopt.h:D: include/freetype/config/ftoption.h
	sed '
		1i\
		// generated file, do not edit. See ../mkfile
...
nuke:V:
	rm -f *.[$OS] src/*/*.[$OS] $CLEANFILES
	rm -f libfreetype.a[$OS] include/p9ftopt.h
